...
Scenarios captured from the real runs that built this skill (2026-07-01), in a
scratch TS repo (`acme-parser`) and a private skill-testing repo.

Last verified: 2026-07-04 (Scenarios 1–2 live 2026-07-01; Scenario 3 concurrent-vanish
path live 2026-07-01 but its Step-3 offer-on-decline sub-path design-verified — added after
the run, never replayed live; Scenario 4 live 2026-07-04)
...
clean-tree re-check → "nothing to commit, commit 3dc9dc5") was **live** 2026-07-01; the Step-3
offer-on-decline sub-path is **design-verified only** (it was added to the skill after this run
per commit `159cedc` and never replayed through a live run — the parenthetical below says so).
...
**Status:** Live-verified 2026-07-04 (closes the remnant on #32). Scratch repo with two
