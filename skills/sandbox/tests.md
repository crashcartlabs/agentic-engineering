...
Last verified: 2026-07-09 — **Scenarios 1–3 design-verified for the current
archive-seeded implementation.** The 2026-07-05 live run below exercised the superseded
read-only-checkout-mount design and remains historical evidence only. It ran end to end
on this machine (colima daemon 29.5.2):
...
**Historical run record (2026-07-05, superseded mount design):** exactly this fixture. Scratch repo at
