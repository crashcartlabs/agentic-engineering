...
(verification record at the bottom of this file). Scenario 3's original expected-output
wording was corrected by the live run — see the note inside it.

Last traced: live run, scratch repo
...
clearly purposeful and independent. (This is the exact fixture the live run used.)
...
**Corrected by the live run:** this scenario originally expected plain
