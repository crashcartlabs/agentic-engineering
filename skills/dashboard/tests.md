...
**Live-verified (2026-07-06, this repo):** ran `nohup python3 scripts/dashboard/
...
**Live-verified (2026-07-06, this repo):** with no `dashboard.pid` present, confirmed
...
**Live-verified (2026-07-06, this repo):** with `config.json` removed, `python3
...
**Live-verified (2026-07-06, this repo):** planted a symlink at a scratch
...
no process was left running. (Amendment 2026-07-06: an earlier version of this fix let
the watch loop keep running after the pidfile refusal — a Codex review on PR #84
...
**Amendment 2026-07-06 (second round):** a later Codex review round on PR #84 caught
...
**Live-verified (2026-07-06, this repo):** started an unrelated long-running process
...
## Dogfood record (2026-07-06, live — this repo checkout, 3 real worktrees + 1 constructed stream)
...
**Live-verified (2026-07-06, this repo):** started `python3 scripts/dashboard/
...
pidfile normally. (Caught by a Codex review on PR #83; a stale, dead-PID pidfile is
...
**Live-verified (2026-07-06, this repo):** called `ensure_local_excludes()` directly
...
**Live-verified (2026-07-06, this repo):** ran `python3 scripts/dashboard/dashboard.py
...
**Live-verified (2026-07-06, this repo):** ran a one-shot render against a scratch
...
**Live-verified (2026-07-06, this repo):** called `run_gh_pr_view(".", "main")` (a
...
**Live-verified (2026-07-06, this repo, underlying mechanics):** this exact
...
**Amendment 2026-07-06:** a further Codex review round caught that the check above
...
**Amendment 2026-07-06 (second round):** the same class of gap existed one step
...
**Live-verified (2026-07-06, this repo):** planted a symlink at the exact predictable
...
**Amendment 2026-07-06:** a further review round caught that `run_watch`'s initial
...
**Live-verified (2026-07-06, this repo):** tested the tightened pattern
...
**Amendment 2026-07-06:** a further review round found the tightened pattern still
...
**Live-verified (2026-07-06, this repo):** wrote that exact exclude line into a
...
**Live-verified (2026-07-06, this repo):** called `ensure_local_excludes({"output_path":
...
**Live-verified (2026-07-06, this repo):** built a throwaway repo with a
...
**Live-verified via `--selftest` (2026-07-08, this repo):** simulated the missing
