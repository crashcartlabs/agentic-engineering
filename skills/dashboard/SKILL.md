---
name: dashboard
description: "Start, inspect, or stop the worktree pipeline dashboard through the installed toolbelt entry point. Invoke the `dashboard` skill with `start` or `stop`."
---
