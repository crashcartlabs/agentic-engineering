...
Vulnerabilities noticed in passing that this change neither introduced nor exposed — surfaced, not scored. (Omit this section if none, or run the `security-audit` skill with `--full` to audit them.)
