...
<!-- §VIII: "none", or each new dependency as "X — because Y". Cite the Research
...
<!-- §V: overall testing approach. Behavioral changes MUST name the test that would fail without the change. -->
...
<!-- §XII: when are we allowed to call this complete? This + Success criteria ARE the reviewer's checklist. -->
