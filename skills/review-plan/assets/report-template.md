...
- <optional> Recommend the `code-audit` skill for general correctness — out of scope here.
```
...
## Notes
- Cycle 1 of 2.
- Recommend the `code-audit` skill for general correctness — out of scope here.
```
...
## Notes
- Cycle 1 of 2.
- Cause is environment, not broken commands: re-run the `review-plan` skill where Redis is available.
```
