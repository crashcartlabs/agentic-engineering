...
This skill owns the red -> green implementation loop. The `plan` skill chooses the success
criteria, seams, and validation strategy; the `execute` skill builds the approved plan; this
